...
echo -e "\n${BLUE}You will need to run ./prod-bigpods.sh again to restart.${NC}\n"
...
$DOCKER_COMPOSE -f docker-compose.bigpods.prod.yml down || true
...
$DOCKER_COMPOSE -f docker-compose.bigpods.prod.yml down -v || true
...
echo -e "  ${GREEN}1.${NC} Run ${BLUE}$SCRIPT_DIR/prod-bigpods.sh${NC} to restart the environment"
