#!/usr/bin/env python3
"""
Crash Notifier for DreamScape Core Pod
DR-336: INFRA-010.3 - Handles process crash notifications and alerts
"""
...
class CrashNotifier:
    ...
    def __init__(self):
        self.critical_processes = ['auth-service', 'user-service', 'nginx']
