#!/usr/bin/env python3
"""
Health Monitor for DreamScape Business Pod
DR-327: INFRA-011 - Monitors all services and provides aggregated health status
"""
...
class HealthMonitor:
    """Monitors health of all services in the Business Pod"""
    ...
    def __init__(self):
        ...
        self.status_file = '/tmp/business_pod_health.json'
    ...
    def check_service_health(self, service_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            request = urllib.request.Request(
                config['url'],
                headers={'User-Agent': 'BusinessPod-HealthMonitor/1.0'}
            )
